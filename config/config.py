...
class Config:
    def __init__(self):
        self.rest_api = {'url': 'https://latest:443/api', 'username': 'admin@internal', 'password': 'redhat'}
        ...
        self.hosts = []
        self.hosts.append(Host({'name': 'node-a', 'host': 'latest-a', 'root_password': "redhat"}, {'cluster': self.cluster}))
        self.hosts.append(Host({'name': 'node-b', 'host': 'latest-b', 'root_password': "redhat"}, {'cluster': self.cluster}))
